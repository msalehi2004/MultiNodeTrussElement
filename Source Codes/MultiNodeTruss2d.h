#ifndef MULTINODETRUSS2D_H
#define MULTINODETRUSS2D_H
...
class MultiNodeTruss2d : public Element
{
public:
	// Constructors
	MultiNodeTruss2d();
	MultiNodeTruss2d(int tag, int N,  int *nodes, UniaxialMaterial **mat, double a);

	// Destructor
	~MultiNodeTruss2d();

	// Method to Get Class Type
	const char *getClassType() const { return "MultiNodeTruss2d"; };
...
private:
	...
	double Lnew;							// element's new length
